...
public:
  ...
  bool testForTermination()
  {
    ...
    // TolFunHist
    if(!bRet && (gen > *(funcValueHistory - 1)))
    {
    ...
    if(!bRet && maxEW >= minEW* dMaxSignifKond)
    {
			bRet=true;
