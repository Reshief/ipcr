...
if __name__ == "__main__":
    ...
    parser.add_argument("input_path", help='Path to the "_mapping.txt" mapping output')
    parser.add_argument(
    ...
    parser.add_argument("input_before_img", help="Path to the full image of before")
    parser.add_argument("input_after_img", help="Path to the full image of after")
    parser.add_argument(
        "-o",
        "--output_path",
        default=None,
